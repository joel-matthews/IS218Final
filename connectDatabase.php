<?php
	...
	$database = 'jpm88';		// This should be your UCID (same as username)
	$username = 'jpm88';		// This should be your UCID (same as database name)
	$password = '1sTR30KZ';	// This is your NJIT mySQL password. It is likely different from your UCID password.
